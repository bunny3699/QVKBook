const productDetails = [
    {
      ...
      qty: 10,
      heading: "Chicken Biryani Boneless - Serves 1",
      des:
      ...
      "Served with 1 Gulab Jamun & Mint Raita] Adorned with fresh vegetables, golden-hued long-grain basmati, & the coveted Behrouz spice mix, this dish will lend you an experience unlike any other." },
    {
      name: "Dum Gosht",
      price: 425,
      imageUrl: "images/b3.jpeg",
      qty: 20,
      heading: "Mutton Biryani, Boneless - Serves 1",
      des:
      "In this most enigmatic & treasured recipe of Behrouz, immaculately spiced fresh, succulent mutton pieces are layered with basmati & then slow-cooked on a charcoal fire." },
    {
      name: "Zaikedaar Paneer ",
      price: 295,
      imageUrl:"images/b4.jpeg",
      qty: 35,
      heading: "Paneer Biryani - Serves 1",
      des:
    ...
    {
      name: "Murgh Afghani Tikka ",
      price: 345,
      imageUrl:"images/b5.jpeg",
      qty: 25,
      heading: "Boneless, Served with 1 Gulab Jamun & Mint Raita",
      des:
      "Legendary for its rich taste & creamy texture, tender chicken marinated in fresh creamy yoghurt & spices is layered with aromatic basmati. Let your tastebuds feel enchanted!" }];
      const cartDetails = [];
